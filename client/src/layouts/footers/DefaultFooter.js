        ...
        <div className="container">
            ...
            <div className="footer-first">
                <div className="footer-logo">
                    <Link href="/">
                        <img src={appData.footer.logo.image} alt={appData.footer.logo.alt} width={65} />
                    </Link>
                </div>
                <div className="contact-info d-flex-all">
                    
                    <p>Give us a free call @<span>+91 40 3580 8866</span></p>
                </div>
        ...
        <div className="container">
            ...
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
                    <h3>Information</h3>
                    <p>"Unlock Your Potential with Jobminar Consultants - Your One-Stop Solution for Staffing, Web Development, Digital Marketing, Events, and Construction Services. Trust in Experience, Delivering Excellence Since 2020."</p>
                </div>
            </div>
            <div className="col-lg-4 col-md-6 col-sm-12">
                <div className="footer-col">
